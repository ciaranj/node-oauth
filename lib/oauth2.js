 ...
 * @param {Buffer|null} post_body The body to send if this is a POST request
 ...
 *
 * Sends the post_body if the request method is a POST, PUT, or PATCH.
 *
 * @param {Object} http_library The HTTP or HTTPS library to use to execute the request
 * @param {Object} options The options for the request being made
 * @param {string} options.method
 * @param {Buffer|null} post_body
